...
from .views import HomePageView, MyPostsView, DeletePostView, UpdatePostView, UpdateProfileView, render_load_image, render_get_avatar
...
urlpatterns = [
    ...
    path("get_avatar/", view = render_get_avatar, name = 'get_avatar'),
